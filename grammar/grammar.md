...
```mermaid
graph LR
    X["私 (わたし)<br/>watashi<br/><b>X (I)</b>"] --- P["は<br/>wa<br/><b>Topic Particle</b>"] --- Y["日本人 (にほんじん)<br/>nihonjin<br/><b>Y (Japanese)</b>"] --- V["です。<br/>desu.<br/><b>is (Present)</b>"]
...
```mermaid
graph LR
    X["あなた<br/>anata<br/><b>X (You)</b>"] --- P["は<br/>wa<br/><b>Topic Particle</b>"] --- Y["学生 (がくせい)<br/>gakusei<br/><b>Y (Student)</b>"] --- V["です。<br/>desu.<br/><b>are (Present)</b>"]
    style X fill:#ffadad,stroke:#333,stroke-width:2px,color:#000
    style P fill:#ffd6a5,stroke:#333,stroke-width:2px,color:#000
    style Y fill:#caffbf,stroke:#333,stroke-width:2px,color:#000
    style V fill:#fdffb6,stroke:#333,stroke-width:2px,color:#000
...
```mermaid
graph LR
    X["今日 (きょう)<br/>kyou<br/><b>X (Today)</b>"] --- P["は<br/>wa<br/><b>Topic Particle</b>"] --- Y["月曜日 (げつようび)<br/>getsuyoubi<br/><b>Y (Monday)</b>"] --- V["です。<br/>desu.<br/><b>is (Present)</b>"]
    style X fill:#ffadad,stroke:#333,stroke-width:2px,color:#000
    style P fill:#ffd6a5,stroke:#333,stroke-width:2px,color:#000
    style Y fill:#caffbf,stroke:#333,stroke-width:2px,color:#000
    style V fill:#fdffb6,stroke:#333,stroke-width:2px,color:#000
...
```mermaid
graph LR
    X["昨日 (きのう)<br/>kinou<br/><b>X (Yesterday)</b>"] --- P["は<br/>wa<br/><b>Topic Particle</b>"] --- Y["日曜日 (にちようび)<br/>nichiyoubi<br/><b>Y (Sunday)</b>"] --- V["でした。<br/>deshita.<br/><b>was (Past)</b>"]
    style X fill:#ffadad,stroke:#333,stroke-width:2px,color:#000
    style P fill:#ffd6a5,stroke:#333,stroke-width:2px,color:#000
    style Y fill:#caffbf,stroke:#333,stroke-width:2px,color:#000
...
```mermaid
graph LR
    X["彼 (かれ)<br/>kare<br/><b>X (He)</b>"] --- P["は<br/>wa<br/><b>Topic Particle</b>"] --- Y["先生 (せんせい)<br/>sensei<br/><b>Y (Teacher)</b>"] --- V["でした。<br/>deshita.<br/><b>was (Past)</b>"]
    style X fill:#ffadad,stroke:#333,stroke-width:2px,color:#000
    style P fill:#ffd6a5,stroke:#333,stroke-width:2px,color:#000
    style Y fill:#caffbf,stroke:#333,stroke-width:2px,color:#000
    style V fill:#9bf6ff,stroke:#333,stroke-width:2px,color:#000
...
```mermaid
graph LR
    X["夜ご飯 (よるごはん)<br/>yorugohan<br/><b>X (Dinner)</b>"] --- P["は<br/>wa<br/><b>Topic Particle</b>"] --- Y["寿司 (すし)<br/>sushi<br/><b>Y (Sushi)</b>"] --- V["でした。<br/>deshita.<br/><b>was (Past)</b>"]
    style X fill:#ffadad,stroke:#333,stroke-width:2px,color:#000
    style P fill:#ffd6a5,stroke:#333,stroke-width:2px,color:#000
    style Y fill:#caffbf,stroke:#333,stroke-width:2px,color:#000
    style V fill:#9bf6ff,stroke:#333,stroke-width:2px,color:#000
